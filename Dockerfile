...
ARG checkout="master"
ARG git_url="https://github.com/jvxis/lnd"
...
RUN apk add --no-cache --update alpine-sdk \
    ...
    make \
    gcc \
&&  git clone $git_url /go/src/github.com/jvxis/lnd \
&&  cd /go/src/github.com/jvxis/lnd \
...
COPY --from=builder /go/src/github.com/jvxis/lnd/scripts/verify-install.sh /
COPY --from=builder /go/src/github.com/jvxis/lnd/scripts/keys/* /keys/
